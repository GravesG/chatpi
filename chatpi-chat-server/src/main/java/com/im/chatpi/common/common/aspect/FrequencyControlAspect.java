package com.im.chatpi.common.common.aspect;
 ...
 *
 * @author ：GuoZeTao
 * @date ：Created in 2024/6/12 16:49
 * @description：
 */
@Slf4j
@Aspect
...
public class FrequencyControlAspect {
    ...
    @Around("@annotation(com.im.chatpi.common.common.annotation.FrequencyControl) || @annotation(com.im.chatpi.common.common.annotation.FrequencyControlContainer)")
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        Method method = ((MethodSignature) joinPoint.getSignature()).getMethod();
        FrequencyControl[] annotationsByType = method.getDeclaredAnnotationsByType(FrequencyControl.class);
        ...
        for (int i = 0; i < annotationsByType.length; i++) {
            ...
            switch (frequencyControl.target()) {
                ...
                case IP:
                    ...
                    break;
                default:
                    throw new RuntimeException("不支持的FrequencyControl.Target");
            }
